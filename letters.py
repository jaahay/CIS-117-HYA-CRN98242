...
def turtle_uppercase():
    '''Dict of uppercase letter draw functions'''
    return TURTLE_UPPERCASE
...
def turtle_lowercase(): 
    '''Dict of lowercase letter draw functions'''
    return TURTLE_LOWERCASE
